# Generated by Powerlevel10k configuration wizard on 2021-11-17 at 19:04 EST.
...
# 12h time, 2 lines, dotted, right frame, blue-ornaments, sparse, many icons, concise,
...
() {
  ...
  #
  # - P9K_TASKWARRIOR_PENDING_COUNT   The number of pending tasks: `task +next count`.
  # - P9K_TASKWARRIOR_OVERDUE_COUNT   The number of tasks in my inbox: `task +in count`.
  #
