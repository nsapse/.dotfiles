...
_G.packer_plugins = {
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/home/nsapse/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["hop.nvim"] = {
    loaded = true,
    path = "/home/nsapse/.local/share/nvim/site/pack/packer/start/hop.nvim",
  ...
  ["nvim-jdtls"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/nsapse/.local/share/nvim/site/pack/packer/opt/nvim-jdtls",
  ...
  ultisnips = {
    loaded = true,
    path = "/home/nsapse/.local/share/nvim/site/pack/packer/start/ultisnips",
