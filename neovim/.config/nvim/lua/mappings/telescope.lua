...
map.set('n', '<S-Enter>', function() builtin.live_grep(require('telescope.themes').get_ivy({})) end)
...
map.set('n', '<leader>ifc', function() builtin.lsp_incoming_calls(require('telescope.themes').get_ivy({})) end)
map.set('n', '<leader>ofc', function() builtin.lsp_outgoing_calls(require('telescope.themes').get_ivy({})) end)
