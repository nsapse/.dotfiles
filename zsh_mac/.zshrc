...
export ZSH="/Users/noah.sapse/.oh-my-zsh"
...
alias kc="nvim /Users/noah.sapse/.config/kitty/kitty.conf"
alias gw="./gradlew"


# alinasing directories
...
source  /Users/noah.sapse/.fzf/key-bindings.zsh
source  /Users/noah.sapse/.fzf/completion.zsh
...
# trifacta virtualenv alias
# Note that if you install the tf Mac OS helpers (see below)
# there is already one built-in alias for that "tf ."

#set a $TRIFACTA HOME  env variable
alias tfenv="cd /Users/noah.sapse/Developer/trifacta-ayx-cloud/ && source ~/.virtualenvs/trifacta-env/bin/activate"
export TRIFACTA_CONF=$HOME/Developer/trifacta-ayx-cloud/conf
export TRIFACTA_CONFIG_HOME=$HOME/Developer/trifacta-ayx-cloud/
# export PATH="/opt/homebrew/Cellar/python@3.10/:$PATH"
export PATH="/opt/homebrew/opt/python@3.10/bin:$PATH"
alias python="python3"
export TRIFACTA_PYTHON_VIRTUALENV=~/.virtualenvs/trifacta-env/

# For running LBS
export SPRING_PROFILES_ACTIVE=local 

source ${TRIFACTA_CONFIG_HOME}/bin/dev-only/dev-macos-helpers.sh
# launch zoxide
